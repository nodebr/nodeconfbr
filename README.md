...
Para colaborar neste momento, entre em nossa discussão no [Slack da NodeBR](http://slack.nodebr.org/).
...
### Canais de comunicação
  ...
  * Conversas serão feitas e organizadas no canal #nodeconfbr no [Slack da NodeBR](http://slack.nodebr.org/).

### Licença ISC

Copyright (c) 2015-2016, NodeBR <nodebr@nodebr.org>
